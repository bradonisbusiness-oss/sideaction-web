# SideAction Posting Queue — 2026-03-28

Goal: remove posting friction. Do not overthink. Post, learn, repeat.

## Rules
- Keep links plain so they are easy to copy.
- Use one main pain per post: people rewrite the bet after they lose.
- Reply fast to comments with the reply bank in `GROWTH_ASSETS_2026-03-28.md`.
- Do not send traffic to generic links when a mapped campaign link exists.
...
### X post
**Reuse winner**
- Repost the best-performing X angle from Days 1–6 with a stronger hook line.
- Keep the same best-fit link.

### Instagram post
**Reuse winner**
- Repost the best-performing carousel or reel with a tighter first slide / hook.
- Keep the same best-fit link.

## What to watch
- Which `fit=` angle gets the most signups: `sports-bets`, `prop-bets`, or `side-deals`
- Which objection shows up most in replies: sportsbook, money, or proof
- Which pain lands hardest: rewriting terms, payout confusion, or buried texts

## Best next move after 7 days
If one angle clearly wins, the landing page hero and top CTA should lean even harder into that use case instead of staying broad.